defmodule NextRideWeb.VehicleControllerTest do
  use NextRideWeb.ConnCase

  alias NextRide.Listings

  @create_attrs %{city: "some city", description: "some description", make: "some make", model: "some model", price: 42, trim: "some trim", year: 42, zip: 42}
  ...
  def fixture(:vehicle) do
    {:ok, vehicle} = Listings.create_vehicle(@create_attrs)
    vehicle
  end
